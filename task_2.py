...
class HistoryDict:
    ...
    def get_history(self):
        return f'list of last ten keys: {list(self.HISTORY.keys())[:-11:-1]}'
...
class TestHistory(unittest.TestCase):
    def setUp(self) -> None:
        self.d = HistoryDict({'foo', 42})

    def test_set_vlue(self):
        self.assertEqual(self.d.set_value('tes 11', 54), None)

    def test_get_history(self):
        self.assertIsInstance(self.d.get_history(), str)